    ...
    <div className="page animate-fade-up">
      ...
      {!aiEnabled ? (
        <div style={{ padding: '4rem 1.5rem', textAlign: 'center' }}>
          <div className="ai-icon-wrap" style={{ width: 80, height: 80, margin: '0 auto 2rem', background: 'var(--surface-low)' }}>
            <BrainCircuit size={40} color="var(--on-surface-faint)" />
          </div>
          <h2 style={{ marginBottom: '1rem' }}>AI Features Disabled</h2>
          <p className="text-muted" style={{ maxWidth: 400, margin: '0 auto 2rem', lineHeight: 1.6 }}>
            Enable Smart Spending Insights in your profile settings to unlock personalized reports and recommendations.
          </p>
